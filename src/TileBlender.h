...
typedef struct {
    ...
    const char *five_channel[5] = {"0000FF", "00FFFF", "00FF00", "FFFF00",
                                   "FF0000"};  // blue, cyan, green, yellow and red
} DefaultColors;
...
public:
    ...
    */
    void getRawTilesAndPreprocess(Session *session, int resolution, int tile,
